    ...
    <>
        ...
        <div className="max-w-6xl mx-auto flex justify-between items-center px-5">
          ...
          <nav className="hidden lg:flex">
            <ul className="flex gap-2 flex-wrap justify-end">
              ...
              <li><Link to="/emergencia" className="nav-btn active"><i className="fas fa-exclamation-triangle"></i> Emergencia</Link></li>
      ...
      <nav className={`lg:hidden bg-white shadow-md transition-all duration-300 ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
        <ul className="p-5 space-y-4">
          ...
          <li><Link to="/emergencia" className="flex items-center gap-2 text-red-500 font-medium"><i className="fas fa-exclamation-triangle"></i> Emergencia</Link></li>

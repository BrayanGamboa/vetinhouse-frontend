...
export default function RegisterSuccessAnimation() {
        ...
        <div className="text-center text-white animate-[successBounce_0.8s_ease-out]">
          ...
          <div className="relative mb-8">
            <div className="w-30 h-30 bg-white rounded-full flex items-center justify-center mx-auto shadow-[0_0_50px_rgba(255,255,255,0.5)] animate-[checkmarkPulse_2s_infinite]">
              <i className="fas fa-user-check text-6xl text-[#4CAF50] animate-[checkmarkRotate_0.6s_ease-in-out_0.3s_both]"></i>
            </div>
          ...
          <div className="flex justify-center gap-5 mb-10">
            <i className="fas fa-user-plus text-3xl text-white animate-[pawBounce_1s_ease-in-out_infinite]"></i>
            <i className="fas fa-heart text-3xl text-white animate-[pawBounce_1s_ease-in-out_infinite] [animation-delay:0.2s]"></i>
